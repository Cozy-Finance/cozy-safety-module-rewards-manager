...
contract RewardMathLibTest is TestBase {
  ...
  function test_negLn_edgeCases() public {
    ...
    vm.expectRevert("RewardMathLib: x out of (0,1]");
    RewardMathLib.negLn(0);

    // Test boundary: negLn(x > 1) should revert
    vm.expectRevert("RewardMathLib: x out of (0,1]");
    RewardMathLib.negLn(WAD + 1);

    // Test very small value
    uint256 negLnSmall = RewardMathLib.negLn(1); // 1 wei
  ...
  function testFuzz_negLn_validRange(uint256 x) public {
    ...
    uint256 result = RewardMathLib.negLn(x);
  ...
  function test_expNeg_edgeCases() public {
    ...
    assertEq(RewardMathLib.expNeg(42e18), 0, "expNeg(42) should be 0");
    assertEq(RewardMathLib.expNeg(100e18), 0, "expNeg(100) should be 0");

    // Test boundary around 42
    assertGt(RewardMathLib.expNeg(41e18), 0, "expNeg(41) should be > 0");
    assertEq(RewardMathLib.expNeg(42e18), 0, "expNeg(42) should be 0");
  }
  ...
  function testFuzz_expNeg_validRange(uint256 x) public {
    ...
    uint256 result = RewardMathLib.expNeg(x);
  ...
  function test_roundTrip_fixedValues() public {
    ...
    for (uint256 i = 0; i < testValues.length; i++) {
      ...
      uint256 negLnX = RewardMathLib.negLn(x);
      uint256 expNegResult = RewardMathLib.expNeg(negLnX);
  ...
  function test_negLn_monotonicity() public {
    ...
    uint256 negLnX1 = RewardMathLib.negLn(x1);
    uint256 negLnX2 = RewardMathLib.negLn(x2);
    uint256 negLnX3 = RewardMathLib.negLn(x3);
  ...
  function test_expNeg_monotonicity() public {
    ...
    uint256 expNegX1 = RewardMathLib.expNeg(x1);
    uint256 expNegX2 = RewardMathLib.expNeg(x2);
    uint256 expNegX3 = RewardMathLib.expNeg(x3);
  ...
  function test_compoundRetention() public {
    ...
    uint256 negLnR1 = RewardMathLib.negLn(r1);
    uint256 negLnR2 = RewardMathLib.negLn(r2);
    uint256 negLnR3 = RewardMathLib.negLn(r3);

    // Sum of -ln values
    uint256 sumNegLn = negLnR1 + negLnR2 + negLnR3;

    // exp(-sum) should equal the product
    uint256 compoundRetention = RewardMathLib.expNeg(sumNegLn);
